...
import RomanticDrama from "./RomanticDrama";
import DarkDrama from "./DarkDrama";
        ...
        <div className={classes.root}>
            ...
            >
                ...
                <div style={{ backgroundColor: "lightgrey", boxShadow: "5px 5px black", position: "static" }}>
                    <h1 style={{ textAlign: "center" }}>Drama</h1>
                </div>
                <div>
                    <h2 style={{ textAlign: "center" }}>What Type of Drama are You Interested in?</h2>
                </div>
                <div>
