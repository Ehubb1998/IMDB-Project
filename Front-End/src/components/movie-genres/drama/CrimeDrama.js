...
import clip from './clips/knivesOutClip.mp4'
import poster from './images/knivesOut.png';
...
const CrimeDrama = () => {
    ...
    const handleClick = () => {
        window.localStorage.setItem("CATEGORY2", "crimeDrama");
    ...
    return (
        <div>
            <div>
                <div id="crimeDrama" className="videoBox2" style={{ cursor: "pointer", width: "320px", height: "240px" }}>
