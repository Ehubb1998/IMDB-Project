...
import clip from './clips/TIMClip.mp4'
import poster from './images/TIM.jpg';
...
const PsychologicalHorror = () => {
    ...
    const handleClick = () => {
        window.localStorage.setItem("CATEGORY2", "psychoHorror");
    ...
    return (
        <div>
            <div>
                <div id="psychoHorror" className="videoBox2" style={{ cursor: "pointer", width: "320px", height: "240px" }}>
            ...
            <div onClick={handleClick} className="hvr-grow-shadow" id="genreButton2" style={{ backgroundColor: "lightgrey", width: "320px", fontWeight: "700", borderRadius: "18px", textAlign: "center", cursor: "pointer" }}>
                <h2>Psychological Horror</h2>
            </div>
        </div>
    )
}

export default PsychologicalHorror;