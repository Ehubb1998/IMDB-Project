...
import clip from './clips/screamClip.mp4'
import poster from './images/scream.jpg';
...
const SlasherHorror = () => {
    ...
    const handleClick = () => {
        window.localStorage.setItem("CATEGORY2", "slasher");
    ...
    return (
        <div>
            <div>
                <div id="slasher" className="videoBox2" style={{ cursor: "pointer", width: "320px", height: "240px" }}>
            ...
            <div onClick={handleClick} className="hvr-grow-shadow" id="genreButton3" style={{ backgroundColor: "lightgrey", width: "320px", fontWeight: "700", borderRadius: "18px", textAlign: "center", cursor: "pointer" }}>
                <h2>Slasher Movies</h2>
            </div>
        </div>
    )
}

export default SlasherHorror;