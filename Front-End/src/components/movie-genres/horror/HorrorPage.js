...
import PsychologicalHorror from "./PsychologicalHorror";
import SlasherHorror from "./SlasherHorror";
import SupernaturalHorror from "./SupernaturalHorror";
        ...
        <div className={classes.root}>
            ...
            >
                ...
                <div style={{ backgroundColor: "lightgrey", boxShadow: "5px 5px black", position: "static" }}>
                    <h1 style={{ textAlign: "center" }}>Horror</h1>
                </div>
                <div>
                    <h2 style={{ textAlign: "center" }}>What Type of Horror are You Interested in?</h2>
                </div>
                <div>
